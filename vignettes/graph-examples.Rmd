...
plot(fixed_sequence_graph, nrow = 1, asp = 0.5, vertex.size = 60)
...
plot(fallback_graph, nrow = 1, asp = 0.5, vertex.size = 40)
...
plot(
  ...
  asp = 0.05,
  vertex.size = 40,
  edge_curves = c("pairs" = 10, "H3|H1" = -20)
)
...
plot(
  ...
  asp = 0.05,
  eps = 0.0001,
  edge_curves = c("pairs" = 10, "H3|H1" = -15),
  vertex.size = 40
)
