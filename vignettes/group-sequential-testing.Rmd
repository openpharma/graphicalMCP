...
## Case Study: Oncology Trial with Different Numbers of Analyses

This example is adapted from the
[gMCPLite vignette](https://cran.r-project.org/package=gMCPLite/vignettes/GraphicalMultiplicity.html)
and demonstrates a more complex scenario where hypotheses have different numbers
of analyses. This is common in oncology trials where different endpoints mature
at different rates.
...
onc_summary_lb <- data.frame(
  ...
  `Not rejected at` = ifelse(
    result_onc_lb$outputs$rejected, "—",
    as.character(last_tested)
  ),
  check.names = FALSE
)
